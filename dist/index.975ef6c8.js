...
function fetchCatByBreed(breedId) {
    return fetch(`https://api.thecatapi.com/v1/images/search?breed_ids=${breedId}`, {
        ...
        if (!response.ok) throw new Error("Failed to fetch cat information.");
        return response.json();
    }).then((data)=>{
...
},{"slim-select":"lzHUr","notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lzHUr":[function(require,module,exports) {
...
},{}]},["igKGj","8lqZg"], "8lqZg", "parcelRequired7c6")
